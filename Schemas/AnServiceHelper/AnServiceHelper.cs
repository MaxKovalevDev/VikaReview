namespace Terrasoft.Configuration
{
    ...
    // Ћучше AnPokemonHelper или AnPokemonServerUtils
	public class AnServiceHelper
	{
        ...
        //»мена public методов должны начинатьс€ с большой буквы
        //»мена методов должны быть пон€тны, непон€тно, какой Id получает метод getId или что и куда вставл€ет метод insert
        //ћежду методами должна быть пуста€ строка, так легче читать код
		public string getId()
		{
		...
		public void insert()
		{
			...
			insertMove.Execute();
            // непон€тно, зачем тут Sselect, если результат нигде не используетс€
        ...
        //Ќепон€тны названи€ переменных, если sourceExpression1 и sourceExpression2 - это Id, то тип данных должен быть Guid
        ...
        // Ћогичнее было бы назвать метод CreatePokemon или InsertPokemon, не вижу смысла использовать перегрузку
        ...
        public void setImageId(AnPokemonProxy pokemon)
		{
            ...
            //"image/png" - неправильно, т.к. изображение может быть в другом формате, правильнее было бы получить Mime type из расширени€
